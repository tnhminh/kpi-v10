...
2. Run relevant automated verification.
3. Review code for correctness, security, data integrity, and regression risk.
4. Update `STATUS.md`, `HANDOFF.md`, `QA.md`, and `DECISIONS.md` when applicable.
5. Review documentation for consistency with the code.
6. Re-run verification before marking the task complete.
...
- [ ] Automated unit/integration/E2E coverage for critical workflows.
...
- [ ] Documentation and handoff fully reflect implemented behavior.
